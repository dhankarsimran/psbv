...
const CompanySection = () => {
  ...
  useEffect(() => {
    const img = new Image();
    img.src = "/images/psbvcompany-min.jpg"; // Replace with your image path
          ...
          <Box
            sx={{
              ...
              backgroundImage: bgLoaded
                ? 'url("/images/psbvcompany-min.jpg")'
                : "none",
                ...
                >
                  ...
                  <Box sx={{ ml: 4 }}>
                    ...
                    >
                      ...
                      ensuring durability and performance in every application.
                    </Typography>
                  </Box>
                </Box>
              </Grid>
              <Grid item sx={12} md={6}>
                ...
                >
                  ...
                  <Box sx={{ ml: 4 }}>
                    ...
                    >
                      We offer a wide variety of pipes and fittings, catering to
                      all industrial and residential needs. Whatever your
              ...
              <Grid item sx={12} md={6}>
                ...
                >
                  ...
                  <Box sx={{ ml: 4 }}>
                    ...
                    >
                      We believe in providing quality without breaking the bank.
